            ...
            <tr class="hover:bg-blue-50">
              ...
              <td class="px-6 py-4">
                <?php
                  ...
                  if ($status === 'pending') $badge = 'bg-yellow-100 text-yellow-700';
                  elseif ($status === 'verifikasi') $badge = 'bg-blue-100 text-blue-700';
                ?>
                <span class="badge <?= $badge ?> shadow"> <?= ucfirst($status) ?> </span>
              </td>
              <td class="px-6 py-4">
